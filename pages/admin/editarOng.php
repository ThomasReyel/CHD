...
$listasOng = $admin->LocalizarOng($_POST['id']);
$listasEndOng = $admin->LocalizarEndOng($listasOng['ong_eno_id']);
   ...
   <div class="container-fluid py-5 bg-body-secondary" >
    <div class="row justify-content-center" >
        ...
        <div class="col-7 mb-5 p-4 rounded-4 bg-primary-subtle">
            ...
            <form action="/edicaoOng" method="post" class="row g-3">
                <div class="col-8">
                    <label for="inputAddress" class="form-label">Nome Fantasia</label>
                    <input type="text" class="form-control" id="inputAddress" value=" <?= $listasOng['ong_nome'] ?>" name="nomeFantasia">
                </div>
                <div class="col-4">
                    <label for="inputAddress" class="form-label">CNPJ</label>
                    <input type="text" class="form-control" id="inputAddress" value=" <?= $listasOng['ong_cnpj'] ?>" name="CNPJ">
                </div>
                <div class="col-7">
                    <label for="inputEmail4" class="form-label">Email</label>
                    <input type="email" class="form-control" id="inputEmail4" value=" <?= $listasOng['ong_email'] ?>" name="EmailOng">
                </div>
                <div class="col-5">
                    <label for="inputPassword4" class="form-label">Senha</label>
                    <input type="password" class="form-control" id="inputPassword4" placeholder="Digite sua senha aqui" name="SenhaOng">
                </div>
                <div class="col-8">
                    <label for="inputAddress" class="form-label">Rua</label>
                    <input type="text" class="form-control" id="inputAddress" required value="<?= $listasEndOng['eno_rua'] ?>" name="RuaOng">
                </div>
                <div class="col-4">
                    <label for="inputAddress" class="form-label">Bairro</label>
                    <input type="text" class="form-control" id="inputAddress" required value="<?= $listasEndOng['eno_bairro'] ?>" name="BairroOng">
                </div>
                <div class="col-5">
                    <label for="validationCustom01" class="form-label">Cidade</label>
                    <input type="text" class="form-control" id="validationCustom01" required value="<?= $listasEndOng['eno_bairro'] ?>" name="CidadeOng">
                </div>
                <div class="col-3">
                    <label for="validationCustom02" class="form-label">Estado</label>
                    <input type="text" class="form-control" id="validationCustom02" required value="<?= $listasEndOng['eno_bairro'] ?>" name="EstadoOng">
                </div>
                <div class="col-4">
                    <label for="validationCustom02" class="form-label">CEP</label>
                    <input type="text" class="form-control" id="validationCustom02" required value="<?= $listasEndOng['eno_bairro'] ?>" name="CEP">
                </div>
                <div class="col-4">
                    <label for="validationCustom02" class="form-label">Numero</label>
                    <input name="Numero" type="text" class="form-control" id="validationCustom02" required value="<?= $listasEndOng['eno_bairro'] ?>">
                </div>
                <div>
                <select class="form-select form-select-sm mb-4" aria-label=".form-select-sm example">
                    <option selected>Tipo de Ong</option>
                    <option value="1">Apoio a moradores de rua</option>
                    <option value="2">Apoio a animais de rua</option>
                    <option value="3">Assistencia a famílias carentes</option>
                    <option value="4">Lar de idosos</option>
                    <option value="5">Orfanato</option>
                </select>
                </div>
                <div class="col-12">
                    ...
                    Declaro que li e concordo com os <a href="/termos">termos de segurança e serviço.</a>
                    </label>
                    </div>
                </div>
                <div class="col-12">
                    <button type="submit" class="btn btn-primary" value="<?= $listasOng['ong_id']?>" name="id">Enviar</button>
                </div>
            </form>
        </div>
