<?php
$admin = new Admin();
$listasDoador = $admin->LocalizarDoador($_POST['id']);
$listasEnd = $admin->LocalizarEnd($listasDoador['doa_end_id']);
   ...
   <div class="container-fluid py-5 bg-body-secondary" >
    <div class="row justify-content-center" >
        ...
        <div class="col-7 mb-5 p-4 rounded-4 bg-primary-subtle">
            ...
            <form action="/edicaoDoador" class="row g-3" method="post">
                
                <div class="col-8">
                    <label for="inputAddress" class="form-label">Nome completo</label>
                    <input name="nome" type="text" class="form-control" id="inputAddress" value=" <?= $listasDoador['doa_nome'] ?>">
                </div>
                <div class="col-4">
                    <label for="inputAddress" class="form-label">CPF</label>
                    <input name="CPF" type="text" class="form-control" id="inputAddress" value="<?= $listasDoador['doa_cpf'] ?>">
                </div>
                <div class="col-7">
                    <label for="inputEmail4" class="form-label">Email</label>
                    <input name="email" type="email" class="form-control" id="inputEmail4" value="<?= $listasDoador['doa_email'] ?>">
                </div>
                <div class="col-5">
                    <label for="inputPassword4" class="form-label">Nova Senha</label>
                    <input name="password" type="password" class="form-control" id="inputPassword4" placeholder="Digite a nova senha">
                </div>
                <div class="col-8">
                    <label for="inputAddress" class="form-label">Endereço</label>
                    <input name="end" type="text" class="form-control" id="inputAddress" value="<?= $listasEnd['end_rua'] ?>">
                </div>
                <div class="col-4">
                    <label for="inputAddress" class="form-label">Bairro</label>
                    <input name="bairro" type="text" class="form-control" id="inputAddress" value="<?= $listasEnd['end_bairro'] ?>">
                </div>
                <div class="col-5">
                    <label for="validationCustom01" class="form-label">Cidade</label>
                    <input name="cidade" type="text" class="form-control" id="validationCustom01" required value="<?= $listasEnd['end_cidade'] ?>">
                </div>
                <div class="col-3">
                    <label for="validationCustom02" class="form-label">Estado</label>
                    <input name="estado" type="text" class="form-control" id="validationCustom02" required value="<?= $listasEnd['end_estado'] ?>">
                </div>
                <div class="col-4">
                    <label for="validationCustom02" class="form-label">CEP</label>
                    <input name="CEP" type="text" class="form-control" id="validationCustom02" placeholder="00000-000" required value="<?= $listasEnd['end_cep'] ?>">
                </div>
                <div class="col-4">
                    <label for="validationCustom02" class="form-label">Numero</label>
                    <input name="Numero" type="text" class="form-control" id="validationCustom02" placeholder="Numero da Casa" required value="<?= $listasEnd['end_numero'] ?>">
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                    <button type="submit" class="btn btn-primary" value="<?= $listasDoador['doa_id'] ?>" name="id">Alterar Dados</button>
                </div>
            </form>
        </div>
