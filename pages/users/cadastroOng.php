   ...
   <div class="container-fluid py-5 bg-body-secondary" >
    <div class="row justify-content-center" >
        ...
        <div class="col-7 mb-5 p-4 rounded-4 bg-primary-subtle">
            ...
            <form action="/cadastrarOng" method="post" class="row g-3">
                <div class="col-8">
                    <label for="inputAddress" class="form-label">Nome Fantasia</label>
                    <input type="text" class="form-control" id="inputAddress" placeholder="" name="nomeFantasia">
                </div>
                <div class="col-4">
                    <label for="inputAddress" class="form-label">CNPJ</label>
                    <input type="text" class="form-control" id="inputAddress" placeholder="XX. XXX. XXX/000Y-XX" name="CNPJ">
                </div>
                <div class="col-7">
                    <label for="inputEmail4" class="form-label">Email</label>
                    <input type="email" class="form-control" id="inputEmail4" name="EmailOng">
                </div>
                <div class="col-5">
                    <label for="inputPassword4" class="form-label">Senha</label>
                    <input type="password" class="form-control" id="inputPassword4" name="SenhaOng">
                </div>
                <div class="col-8">
                    <label for="inputAddress" class="form-label">Rua</label>
                    <input type="text" class="form-control" id="inputAddress" placeholder="Rua, N" name="RuaOng">
                </div>
                <div class="col-4">
                    <label for="inputAddress" class="form-label">Bairro</label>
                    <input type="text" class="form-control" id="inputAddress" name="BairroOng">
                </div>
                <div class="col-5">
                    <label for="validationCustom01" class="form-label">Cidade</label>
                    <input type="text" class="form-control" id="validationCustom01" required name="CidadeOng">
                </div>
                <div class="col-3">
                    <label for="validationCustom02" class="form-label">Estado</label>
                    <input type="text" class="form-control" id="validationCustom02" required name="EstadoOng">
                </div>
                <div class="col-4">
                    <label for="validationCustom02" class="form-label">CEP</label>
                    <input type="text" class="form-control" id="validationCustom02" placeholder="00000-000" required name="CEP">
                </div>
                <div class="col-4">
